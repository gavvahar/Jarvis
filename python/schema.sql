...
ALTER TABLE user_configs ADD COLUMN IF NOT EXISTS tts_rate REAL NOT NULL DEFAULT 1.0;
ALTER TABLE user_configs ADD COLUMN IF NOT EXISTS tts_pitch REAL NOT NULL DEFAULT 1.0;
ALTER TABLE user_configs ADD COLUMN IF NOT EXISTS tts_volume REAL NOT NULL DEFAULT 1.0;
