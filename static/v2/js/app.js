...
(function () {
  ...
  const calendarPasswordInput = $("calendar-password");
  const contactsUrlInput = $("contacts-url");
  const contactsUsernameInput = $("contacts-username");
  const contactsPasswordInput = $("contacts-password");
  ...
  function setCalendarStatus(configured, url, username) {
  ...
  function setContactsStatus(configured, url, username) {
  ...
  const financeLinkBtn = $("finance-link-btn");
  const financeConnList = $("finance-connections-list");
  const financeMsg = $("finance-msg");
  const financeEnvLabel = $("finance-env-label");

  function setFinanceStatus(configured) {
